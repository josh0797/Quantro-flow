...
export const translations = {
  ...
  es: {
    ...
    onboarding: {
      ...
      summary: '{{completed}} de {{total}} miembros con onboarding completo',
      member_progress: '{{completed}}/{{total}}',
      ...
      step_account_created_done: 'La cuenta ya está creada.',
      step_account_created_pending: 'La cuenta todavía no ha sido creada.',
      step_companies_assigned_done: 'El espacio ya está asociado a una empresa.',
      step_companies_assigned_pending: 'Falta asignar empresa antes de activar el acceso.',
      step_role_configured_done: 'Rol asignado y configurado.',
      step_role_configured_pending: 'Sigue como visualizador hasta asignarle un rol.',
      step_first_login_done: 'Ya inició sesión por primera vez.',
  ...
  en: {
    ...
    onboarding: {
      tab_label: 'Onboarding',
      summary: '{{completed}} of {{total}} members with onboarding complete',
      member_progress: '{{completed}}/{{total}}',
      ...
      step_invitation_sent_done: 'This member already received the invitation.',
      step_invitation_sent_pending: 'Generate a link to invite them.',
      step_account_created_done: 'Account is created.',
      step_account_created_pending: 'The account hasn\u2019t been created yet.',
      step_companies_assigned_done: 'The workspace is associated with a company.',
      step_companies_assigned_pending: 'Assign a company before activating access.',
      step_role_configured_done: 'Role assigned and configured.',
      step_role_configured_pending: 'Still a viewer until you assign a role.',
      step_first_login_done: 'Has signed in at least once.',
