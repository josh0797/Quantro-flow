  ...
  es: {
    ...
    welcome: {
      ...
      inbox: {
        ...
        skip_cta: 'Conectar después',
        phase_analyzing: 'Analizando conversaciones...',
        phase_detecting: 'Detectando oportunidades...',
        phase_priorit: 'Priorizando acciones...',
        ready_label: 'Bandeja conectada',
        advancing: 'Sincronizando agenda',
      },
      calendar: {
        ...
        skip_cta: 'Sincronizar después',
        ready_label: 'Calendario sincronizado',
        advancing: 'Quantro también coordina tu tiempo',
      },
      crm: {
        ...
        ready_label: 'CRM conectado',
        advancing: 'Tu operación empieza a tomar forma',
      },
      automations: {
        eyebrow_optional: 'Opcional',
        ...
        skip_cta: 'Saltar este paso',
        ready_label: 'Automatizaciones listas',
        advancing: 'Encendiendo Quantro',
      },
      ready: {
        activating: 'Activando Quantro...',
        eyebrow: 'En vivo',
        title: 'Quantro ya está operando contigo',
        title_with_name: '{{name}}, Quantro ya está operando contigo',
        subtitle: 'Aquí va lo que detectamos en tu operación. Empieza desde la bandeja.',
  ...
  en: {
    ...
    welcome: {
      ...
      inbox: {
        ...
        skip_cta: 'Connect later',
        phase_analyzing: 'Analyzing conversations...',
        phase_detecting: 'Detecting opportunities...',
        phase_priorit: 'Prioritizing actions...',
        ready_label: 'Inbox connected',
        advancing: 'Syncing calendar',
      },
      calendar: {
        ...
        skip_cta: 'Sync later',
        ready_label: 'Calendar synced',
        advancing: 'Now Quantro coordinates your time too',
      },
      crm: {
        ...
        ready_label: 'CRM connected',
        advancing: 'Your operation is taking shape',
      },
      automations: {
        eyebrow_optional: 'Optional',
        ...
        skip_cta: 'Skip this step',
        ready_label: 'Automations ready',
        advancing: 'Powering Quantro on',
      },
      ready: {
        activating: 'Activating Quantro...',
        eyebrow: 'Live',
        title: 'Quantro is now operating with you',
        title_with_name: '{{name}}, Quantro is now operating with you',
        subtitle: 'Here\u2019s what we detected in your operation. Start from your inbox.',
